...
static void draw_block_index(Map* M, const int row, const int col) {
	...
	dw = block_width / 3;
		...
		al_draw_filled_rectangle(s_x, s_y,
			e_x, e_y, al_map_rgb(151, 173, 172));
...
static void draw_bean(Map* M, const int row, const int col) {
	al_draw_filled_circle(map_offset_x + col * block_width + block_width / 2.0, map_offset_y + row * block_height + block_height / 2.0, block_width/6.0,  al_map_rgb(255, generateRandomNumber(100,200), generateRandomNumber(70,150)));
}

static void draw_power_bean(Map* M, const int row, const int col) {
	al_draw_filled_circle(map_offset_x + col * block_width + block_width / 2.0, map_offset_y + row * block_height + block_height / 2.0, block_width / generateRandomNumber(1,4), al_map_rgb(255, 94, 72));

}

static void draw_speed_bean(Map* M, const int row, const int col) {
	al_draw_filled_circle(map_offset_x + col * block_width + block_width / 2.0, map_offset_y + row * block_height + block_height / 2.0, block_width / generateRandomNumber(2, 3), al_map_rgb(255, generateRandomNumber(200,255), generateRandomNumber(150,200)));
}
