...
ALLEGRO_SAMPLE* theme2Music = NULL;
ALLEGRO_SAMPLE* fireMusic = NULL;
...
void shared_init(void) {
	...
	theme2Music = load_audio("Assets/Music/theme_music_2.ogg");
	winMusic = load_audio("Assets/Music/win.ogg");
	fireMusic = load_audio("Assets/Music/fire.ogg");
...
void shared_destroy(void) {
	...
	al_destroy_sample(fireMusic);
	al_destroy_sample(theme2Music);
